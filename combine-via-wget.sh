...
REF_WORK_DIR_PATH="${HOME}/work/ubuntu-iso-builder-import-pacstall-cinnamon-style-maccity"
...
echo "[Next Step]: cd ~/work/ubuntu-iso-builder-import-pacstall-cinnamon-style-maccity/iso-profile
"
echo
